...
class TrainingConfig:
    ...
    prune_percentage: float = 0.2  # Percentage of weights that are pruned
    prune_times: int = 22  # Number of time of pruning
    random_prune: bool = False # If use random pruning. Set to yes for random pruning baseline
...
class CheckpointConfig:
    pretrained_model: str = '' # Initialize from a pretrained model
    continue_from: str = ''  # Continue training from checkpoint model
    best_iter: int = 0 # The best pruning iteration, used for train_subnetwork
